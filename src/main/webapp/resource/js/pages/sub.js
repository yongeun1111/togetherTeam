		...
		dataType: "json",
   		success: function(data) {
			...
			if(pro_cate == '공기청정기'){
				...
				proDetailInfo += "<tr>";
				proDetailInfo += "<td col='col' width='15%'> 제조사 </td>";
				proDetailInfo += "<td width='35%'>" + pro_Ex[0].company +"</td>";
				proDetailInfo += "<td col='col' width='15%'> 제품명 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].title +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 카테고리 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].품목 +"</td>";
				proDetailInfo += "<td> 용도 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].용도 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 공기청정방식 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].공기청정방식 +"</td>";
				proDetailInfo += "<td> 사용면적 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].사용면적 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 인증 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].인증 +"</td>";
				proDetailInfo += "<td> 필터단계 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].필터단계 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 필터 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].필터 +"</td>";
				proDetailInfo += "<td col='col' width='20%'> 이온 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].이온 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 센서 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].센서 +"</td>";
				proDetailInfo += "<td> 주요기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].주요기능 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 미세먼지 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].미세먼지 +"</td>";
				proDetailInfo += "<td> 풍량조절 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].풍량조절 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 모드 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].모드 +"</td>";
				proDetailInfo += "<td> 청정도표시 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].청정도표시 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 부가기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].부가기능 +"</td>";
				proDetailInfo += "<td> 에너지효율 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].에너지효율 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 소비전력 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].소비전력 +"</td>";
				proDetailInfo += "<td> 크기 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].크기 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 무게 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].무게 +"</td>";
				proDetailInfo += "<td> 소음 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].소음 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 필터등급 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].필터등급 +"</td>";
				proDetailInfo += "<td></td><td></td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "</table>";
				...
				proDetailInfo += "<td> 카테고리 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].품목 +"</td>";
				proDetailInfo += "<td> 용량 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].용량 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 조작부 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].조작부 +"</td>";
				proDetailInfo += "<td> 코팅 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].코팅 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 자동요리메뉴 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].자동요리메뉴 +"</td>";
				proDetailInfo += "<td> 온도조절 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].온도조절 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 타이머 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].타이머 +"</td>";
				proDetailInfo += "<td> 부가기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].부가기능 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 소비전력 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].소비전력 +"</td>";
				proDetailInfo += "<td> 색상 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].색상 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 크기 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].크기 +"</td>";
				proDetailInfo += "<td> 기름받이 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].기름받이 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 무게 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].무게 +"</td>";
				proDetailInfo += "<td> 안전기능 </td>";
				...
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 수위표시창 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].수위표시창 +"</td>";
				proDetailInfo += "<td> 받침대 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].받침대 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 거름망 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].거름망 +"</td>";
				proDetailInfo += "<td> 부가기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].부가기능 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				...
				proDetailInfo += "<td> 크기 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].크기 +"</td>";
				proDetailInfo += "<td> 형태 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].형태 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 재질 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].재질 +"</td>";
				proDetailInfo += "<td> 온도조절 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].온도조절 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 온도범위 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].온도범위 +"</td>";
				proDetailInfo += "<td></td><td></td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "</table>";
				pro_detail.append(proDetailInfo);
				...
				proDetailInfo += "<td> 조작부 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].조작부 +"</td>";
				proDetailInfo += "<td> 조리실코팅 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].조리실코팅 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 자동요리 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].자동요리 +"</td>";
				proDetailInfo += "<td> 조리기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].조리기능 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 온도조절 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].온도조절 +"</td>";
				proDetailInfo += "<td> 스마트인버터 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].스마트인버터 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 부가기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].부가기능 +"</td>";
				proDetailInfo += "<td> 유리 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].유리 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 안전기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].안전기능 +"</td>";
				proDetailInfo += "<td> 절전 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].절전 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 출력 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].출력 +"</td>";
				proDetailInfo += "<td> 소비전력 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].소비전력 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				...
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 도어열림 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].도어열림 +"</td>";
				proDetailInfo += "<td> 무게 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].무게 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "</table>";
				...
				proDetailInfo += "<td> 카테고리 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].품목 +"</td>";
				proDetailInfo += "<td> 투입구 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].투입구 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 주요기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].주요기능 +"</td>";
				proDetailInfo += "<td> 굽기조절 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].굽기조절 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 받침대 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].받침대 +"</td>";
				proDetailInfo += "<td> 구성 </td>";
				...
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 뚜껑기능 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].뚜껑기능 +"</td>";
				proDetailInfo += "<td></td><td></td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "</table>";
				pro_detail.append(proDetailInfo);
				...
				proDetailInfo += "<td> 카테고리 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].품목 +"</td>";
				proDetailInfo += "<td> 손잡이 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].손잡이 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 방식 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].방식 +"</td>";
				proDetailInfo += "<td> 풍량조절 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].풍량조절 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				...
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 발생성분 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].발생성분 +"</td>";
				proDetailInfo += "<td> 노즐 </td>";
				...
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
				proDetailInfo += "<td> 코드길이 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].코드길이 +"</td>";
				proDetailInfo += "<td> 무게 </td>";
				proDetailInfo += "<td>" + pro_Ex[0].무게 +"</td>";
				proDetailInfo += "</tr>";
				proDetailInfo += "<tr>";
